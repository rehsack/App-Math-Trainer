package App::Math::Trainer::Role::NaturalExercise;
...
App::Math::Trainer::Role::NaturalExercise - role for for exercises with natural numbers
...
with "App::Math::Trainer::Role::Exercise", "App::Math::Trainer::Role::Natural";
