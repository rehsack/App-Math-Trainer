package App::Math::Trainer::Role::PowerExercise;
...
App::Math::Trainer::Role::PowerExercise - role for exercises in power mathematics
...
with "App::Math::Trainer::Role::Exercise", "App::Math::Trainer::Role::Power";
